...
public class LevelMakerEditor : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        selected = GUILayout.Toolbar(
            selected,
            toolbarStrings,
            new GUILayoutOption[] { GUILayout.Width(450) }
        );
        GUILayout.EndHorizontal();

        scrollViewVector = GUI.BeginScrollView(
            new Rect(25, 45, position.width - 30, position.height),
            scrollViewVector,
            new Rect(0, 0, 400, 1600)
        );
        GUILayout.Space(-30);
    ...
    void GUIShowWarning()
    {
        ...
        GUILayout.Label(
            ...
            new GUILayoutOption[] { GUILayout.Width(600) }
        );
        GUILayout.Label(
            "Please open scene - game ( Assets/JuiceFresh/Scenes/game.unity )",
            EditorStyles.boldLabel,
            new GUILayoutOption[] { GUILayout.Width(600) }
        );
    }
    ...
    void GUIRate()
    {
        ...
        GUILayout.Space(10);
        GUILayout.BeginHorizontal();
        initscript.ShowRateEvery = EditorGUILayout.IntField(
            "Show Rate every ",
            initscript.ShowRateEvery,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        GUILayout.Label(
            " level (0 = disable)",
            EditorStyles.label,
        ...
        GUILayout.EndHorizontal();
        initscript.RateURL = EditorGUILayout.TextField(
            "URL",
            initscript.RateURL,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        initscript.RateURLIOS = EditorGUILayout.TextField(
            "URL iOS",
            initscript.RateURLIOS,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
    }
    ...
    {
        SearchableEditorWindow[] windows = (SearchableEditorWindow[])
            Resources.FindObjectsOfTypeAll(typeof(SearchableEditorWindow));
        ...
        MethodInfo setSearchType = typeof(SearchableEditorWindow).GetMethod(
            "SetSearchFilter",
    ...
    void GUIAds()
    {
        ...
        {
            Application.OpenURL(
                "https://docs.google.com/document/d/1HeN8JtQczTVetkMnd8rpSZp_TZZkEA7_kan7vvvsMw0"
            );
        }
        ...
        unityAdsSettings.androidID = EditorGUILayout.TextField(
            "Android ID ",
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        unityAdsSettings.iOSID = EditorGUILayout.TextField(
            "iOS ID",
            unityAdsSettings.iOSID,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        ...
        //		if (initscript.enableUnityAds) {
        GUILayout.BeginHorizontal();
        initscript.rewardedGems = EditorGUILayout.IntField(
            "Rewarded gems",
            initscript.rewardedGems,
            new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
        );
        GUILayout.EndHorizontal();
        ...
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobUIDAndroid = EditorGUILayout.TextField(
            "Admob Interstitial ID Android ",
            initscript.admobUIDAndroid,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobUIDIOS = EditorGUILayout.TextField(
            "Admob Interstitial ID iOS",
            initscript.admobUIDIOS,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        GUILayout.EndHorizontal();
        GUILayout.Space(10);
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobRewardedUIDAndroid = EditorGUILayout.TextField(
            "Admob Rewarded ID Android ",
            initscript.admobRewardedUIDAndroid,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        initscript.admobRewardedUIDIOS = EditorGUILayout.TextField(
            "Admob Rewarded ID iOS",
            initscript.admobRewardedUIDIOS,
            new GUILayoutOption[] { GUILayout.Width(220), GUILayout.MaxWidth(220) }
        );
        GUILayout.EndHorizontal();
        //		}
        ...
        {
            Application.OpenURL(
                "https://docs.google.com/document/d/1ibnQbuxFgI4izzyUtT45WH5m1ab3R5d1E3ke3Wrb10Y"
            );
        }
        ...
        EditorGUILayout.LabelField(
            "menu Chartboost->Edit settings",
            new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
        );
        GUILayout.EndHorizontal();
        GUILayout.BeginHorizontal();
        GUILayout.Space(20);
        EditorGUILayout.LabelField(
            "Put ad ID to appropriate platform to prevent crashing!",
            EditorStyles.boldLabel,
            new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(400) }
        );
        GUILayout.EndHorizontal();
        ...
        GUILayout.Label(
            "Event:               Status:                            Show after n call:",
            new GUILayoutOption[] { GUILayout.Width(350) }
        );
    ...
    void GUIInappSettings()
    {
        ...
        {
            lm.InAppIDs[i] = EditorGUILayout.TextField(
                "Product id " + (i + 1),
                lm.InAppIDs[i],
                new GUILayoutOption[] { GUILayout.Width(300), GUILayout.MaxWidth(300) }
            );
        }
        GUILayout.Space(10);
        ...
        GUILayout.Space(10);
        if (
            GUILayout.Button("Android account help", new GUILayoutOption[] { GUILayout.Width(400) })
        )
        {
            Application.OpenURL(
    ...
    {
        GUILayout.Label(
            "Juice Fresh game template - v 1.5.",
            EditorStyles.boldLabel,
            new GUILayoutOption[] { GUILayout.Width(350) }
        );
        GUILayout.Space(10);
        ...
        {
            Application.OpenURL(
                "https://docs.google.com/document/d/1ex3rvCDWAc3geATi66s3lpBzwzhJbjd4A2Fo19HgdcQ/edit"
            );
        }
        GUILayout.Space(10);
        GUILayout.Label(
            "To start work with project - \n go to Editor Section of this menu",
            EditorStyles.boldLabel,
            new GUILayoutOption[] { GUILayout.Width(350) }
        );
        GUILayout.Space(10);
    ...
    void GUISettings()
    {
        ...
        {
            Application.OpenURL(
                "https://docs.google.com/document/d/1JcQfiiD2ALz6v_i9UIcG93INWZKC7z6FHXH_u6w9A8E"
            );
        }
        GUILayout.EndHorizontal();
#if GAMESPARKS
        GUILayout.BeginHorizontal();
        {
            ...
            {
                GamesparksConfiguration window =
                    ScriptableObject.CreateInstance<GamesparksConfiguration>();
        ...
        if (score_settings)
        {
            ...
            GUILayout.Space(30);
            GUILayout.BeginVertical();
            lm.scoreForItem = EditorGUILayout.IntField(
                "Score for item",
                lm.scoreForItem,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            lm.scoreForBlock = EditorGUILayout.IntField(
                "Score for block",
                lm.scoreForBlock,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            lm.scoreForWireBlock = EditorGUILayout.IntField(
                "Score for wire block",
                lm.scoreForWireBlock,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            lm.scoreForSolidBlock = EditorGUILayout.IntField(
                "Score for solid block",
                lm.scoreForSolidBlock,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            lm.scoreForThrivingBlock = EditorGUILayout.IntField(
                "Score for thriving block",
                lm.scoreForThrivingBlock,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            GUILayout.Space(10);

            lm.showPopupScores = EditorGUILayout.Toggle(
                "Show popup scores",
                lm.showPopupScores,
                new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
            );
            ...
            lm.scoresColors[0] = EditorGUILayout.ColorField(
                "Score color item 1",
                lm.scoresColors[0],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColors[1] = EditorGUILayout.ColorField(
                "Score color item 2",
                lm.scoresColors[1],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColors[2] = EditorGUILayout.ColorField(
                "Score color item 3",
                lm.scoresColors[2],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColors[3] = EditorGUILayout.ColorField(
                "Score color item 4",
                lm.scoresColors[3],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColors[4] = EditorGUILayout.ColorField(
                "Score color item 5",
                lm.scoresColors[4],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColors[5] = EditorGUILayout.ColorField(
                "Score color item 6",
                lm.scoresColors[5],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            ...
            lm.scoresColorsOutline[0] = EditorGUILayout.ColorField(
                "Score color outline item 1",
                lm.scoresColorsOutline[0],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColorsOutline[1] = EditorGUILayout.ColorField(
                "Score color outline item 2",
                lm.scoresColorsOutline[1],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColorsOutline[2] = EditorGUILayout.ColorField(
                "Score color outline item 3",
                lm.scoresColorsOutline[2],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColorsOutline[3] = EditorGUILayout.ColorField(
                "Score color outline item 4",
                lm.scoresColorsOutline[3],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColorsOutline[4] = EditorGUILayout.ColorField(
                "Score color outline item 5",
                lm.scoresColorsOutline[4],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            lm.scoresColorsOutline[5] = EditorGUILayout.ColorField(
                "Score color outline item 6",
                lm.scoresColorsOutline[5],
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        if (life_settings_show)
        {
            ...
            initscript.CapOfLife = EditorGUILayout.IntField(
                "Max of lifes",
                initscript.CapOfLife,
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            GUILayout.Space(10);
            ...
            GUILayout.BeginHorizontal();
            GUILayout.Space(30);
            initscript.TotalTimeForRestLifeHours = EditorGUILayout.FloatField(
                "",
                initscript.TotalTimeForRestLifeHours,
                new GUILayoutOption[] { GUILayout.Width(50) }
            );
            initscript.TotalTimeForRestLifeMin = EditorGUILayout.FloatField(
                "",
                initscript.TotalTimeForRestLifeMin,
                new GUILayoutOption[] { GUILayout.Width(50) }
            );
            initscript.TotalTimeForRestLifeSec = EditorGUILayout.FloatField(
                "",
            ...
            lm.lifeShop.CostIfRefill = EditorGUILayout.IntField(
                "Cost of refilling lifes",
                lm.lifeShop.CostIfRefill,
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            GUILayout.EndVertical();
            GUILayout.EndHorizontal();
        ...
        initscript.FirstGems = EditorGUILayout.IntField(
            "Start gems",
            initscript.FirstGems,
            new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
        );
        GUILayout.Space(20);

        initscript.losingLifeEveryGame = EditorGUILayout.Toggle(
            "Losing a life every game",
            initscript.losingLifeEveryGame,
            new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
        );
        GUILayout.Space(20);
        ...
        if (failed_settings_show)
        {
            ...
            lm.FailedCost = EditorGUILayout.IntField(
                new GUIContent("Cost of continue", "Cost of continue after failed"),
                lm.FailedCost,
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            ...
            lm.ExtraFailedSecs = EditorGUILayout.IntField(
                new GUIContent("Extra seconds", "Extra seconds after continue"),
                lm.ExtraFailedSecs,
                new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
            );
            GUILayout.EndVertical();
        ...
        target_description_show = EditorGUILayout.Foldout(
            target_description_show,
            "Targets description:"
        );
        if (target_description_show)
        {
            ...
            {
                lm.targetDiscriptions[i] = EditorGUILayout.TextField(
                    "",
                    lm.targetDiscriptions[i],
                    new GUILayoutOption[] { GUILayout.Width(200), GUILayout.MaxWidth(200) }
                );
            }
            GUILayout.EndVertical();
    ...
    void GUIShops()
    {
        ...
        if (gems_shop_show)
        {
            ...
            foreach (GemProduct item in lm.gemsProducts)
            {
                ...
                GUILayout.BeginHorizontal();
                GUILayout.Space(30);
                item.count = EditorGUILayout.IntField(
                    "",
                    item.count,
                    new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(100) }
                );
                item.price = EditorGUILayout.FloatField(
                    "",
                    item.price,
                    new GUILayoutOption[] { GUILayout.Width(100), GUILayout.MaxWidth(100) }
                );
        ...
        if (boost_show)
        {
            BoostShop bs = GameObject
                .Find("CanvasGlobal")
                .transform.Find("BoostShop")
                .GetComponent<BoostShop>();
            ...
            foreach (BoostProduct item in bp)
            {
                ...
                item.description = EditorGUILayout.TextField(
                    "",
                    item.description,
                    new GUILayoutOption[] { GUILayout.Width(400), GUILayout.MaxWidth(400) }
                );
                GUILayout.EndHorizontal();
                ...
                GUILayout.Label(
                    item.icon.texture,
                    new GUILayoutOption[] { GUILayout.Width(50), GUILayout.Height(50) }
                );
                GUILayout.BeginVertical();
                GUILayout.BeginHorizontal();
                ...
                for (int i = 0; i < 3; i++)
                {
                    ...
                    item.count[i] = EditorGUILayout.IntField(
                        "",
                        item.count[i],
                        new GUILayoutOption[] { GUILayout.Width(80), GUILayout.MaxWidth(80) }
                    );
                    item.GemPrices[i] = EditorGUILayout.IntField(
                        "",
                        item.GemPrices[i],
                        new GUILayoutOption[] { GUILayout.Width(80), GUILayout.MaxWidth(80) }
                    );
    ...
    void GUILevelSelector()
    {
        ...
        string changeLvl = GUILayout.TextField(
            " " + levelNumber,
            new GUILayoutOption[] { GUILayout.Width(50) }
        );
        try
        ...
        GUILayout.Label(
            "Assets/JuiceFresh/Resouces/Levels/",
            EditorStyles.label,
            new GUILayoutOption[] { GUILayout.Width(200) }
        );
        GUILayout.EndHorizontal();
    ...
    void GUILevelSize()
    {
        ...
        maxRows = EditorGUILayout.IntField(
            "Rows",
            maxRows,
            new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
        );
        maxCols = EditorGUILayout.IntField(
            "Columns",
            maxCols,
            new GUILayoutOption[] { GUILayout.Width(50), GUILayout.MaxWidth(200) }
        );
    ...
    void GUIColorLimit()
    {
        ...
        colorLimit = EditorGUILayout.IntField(
            "",
            colorLimit,
            new GUILayoutOption[] { GUILayout.Width(50) }
        );
    ...
    void GUITarget()
    {
        ...
        if (target == Target.COLLECT)
        {
            ...
            for (int i = 0; i < ingr.Length; i++)
            {
                ...
                item.check = EditorGUILayout.Toggle(
                    item.check,
        ...
        else if (target == Target.BOMBS)
        {
            ...
            bombsAtTheSameTime = EditorGUILayout.IntField(
                "bombs collect",
                bombsAtTheSameTime,
                new GUILayoutOption[] { GUILayout.Width(200) }
            );
            ...
            bombTimer = EditorGUILayout.IntField(
                "bombs counter",
                bombTimer,
                new GUILayoutOption[] { GUILayout.Width(200) }
            );
        ...
        {
            oldcageHP = cageHP;
            cageHP = EditorGUILayout.IntField(
                "cageHP",
                cageHP,
                new GUILayoutOption[] { GUILayout.Width(200) }
            );
        ...
        else if (target == Target.SCORE)
        {
            ...
            starsTargetCount = (CollectStars)
                EditorGUILayout.EnumPopup(starsTargetCount, GUILayout.Width(100));
            ...
            for (int col = 0; col < maxCols; col++)
            {
                ...
                else if (levelSquares[row * maxCols + col].block == SquareTypes.EMPTY)
                {
                    ...
                    else if (levelSquares[row * maxCols + col].obstacle == SquareTypes.SOLIDBLOCK)
                    {
                        ...
                        levelSquares[row * maxCols + col].obstacle == SquareTypes.DOUBLESOLIDBLOCK
                    )
                    {
    ...
    public void SaveMap(string fileName)
    {
        ...
        for (int row = 0; row < maxRows; row++)
        {
            ...
            {
                saveString +=
                    (int)levelSquares[row * maxCols + col].block
                    + ""
                    + (int)levelSquares[row * maxCols + col].obstacle;
    ...
    void ProcessGameDataFromString(string mapText)
    {
        ...
        foreach (string line in lines)
        {
            ...
            else if (line.StartsWith("SIZE "))
            {
                ...
                string[] sizes = blocksString.Split(
                    new string[] { "/" },
                    StringSplitOptions.RemoveEmptyEntries
                );
            ...
            else if (line.StartsWith("STARS "))
            {
                ...
                string[] blocksNumbers = blocksString.Split(
                    new string[] { "/" },
                    StringSplitOptions.RemoveEmptyEntries
                );
            ...
            { //Maps
                ...
                {
                    levelSquares[mapLine * maxCols + i].block = (SquareTypes)
                        int.Parse(st[i][0].ToString());
                    levelSquares[mapLine * maxCols + i].obstacle = (SquareTypes)
                        int.Parse(st[i][1].ToString());
                }
                mapLine++;
            }
        }
